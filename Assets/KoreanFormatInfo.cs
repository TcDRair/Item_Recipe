/*
 ? https://github.com/tcaesvk/KoreanFormatInfo/blob/master/ConsoleApplication/KoreanFormatInfo.cs
 * Format 유형 : { 은/는, 과/와, 을/를, (으)로 }
 TODO 각각을 분해해서 Formatter가 아니라 AddParticle(enum Type)으로 구현해봅시다.
*/
using System;
